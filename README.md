...
//module project
     dependencies {
            implementation 'com.github.android-zj:CommonUtil:1.0.2'
    }
...
```java
        ...
        //时间戳转  如2018-06-8 (星期五) 16:40格式
        DataUtils.getDateAndWeek(mDate,Long.parseLong("1537524997000"),mTime);
        //时间戳转时间 如打车根据距离计算出时间有  day-hour-minute/hour-minute/minute
        DataUtils.secondToTime(Long.parseLong("1537524997000"));
